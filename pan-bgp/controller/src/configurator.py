...
class Configurator:
    ...
    def __init__(self, config_file=None):
        ...
        # Loads everyting required for the controller.
        # If something is missing a ValueError is raised
    ...
    def _configure_controller(self):
        ...
        if self.controller.get('port') is None:
            raise ValueError("Controller port is required in config file")
